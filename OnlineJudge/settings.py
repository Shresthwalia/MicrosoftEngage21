...
Generated by 'django-OnlineJudge startproject' using Django 3.2.9.
...
SECRET_KEY = 'django-insecure-we*#4w46=%$s4yqe4)^fsdilx1c%@g1*(4!%e#_c+hd%teuppb'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'OnlineJudge/templates']
        ,
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
